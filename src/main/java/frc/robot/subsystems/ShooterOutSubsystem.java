...
public class ShooterOutSubsystem extends SubsystemBase {
  ...
  public void periodic() {
    if (ShooterConstants.kMotorTargetVelocityFromDashboard) {
      double targetVelocity = SmartDashboard.getNumber("Shooter Out Target Velocity", 0);
    ...
    SmartDashboard.putNumber("Shooter Out Actual Vel", encoder.getVelocity());
    SmartDashboard.putNumber("Shooter Out Amps", motor.getOutputCurrent());
